...
const std::vector<FS> AllPlants_Lv1 =
{
	...
	{4,{615,635},{685,565},{650, 600}},
	{5,{715,635},{785,565},{750, 600}}
};
const std::vector<FS> AllPlants_Lv2 =
{
	{1,{25,585},{95,515},{60, 550}},
	{3,{25,485},{95,415},{60, 450}},
	{4,{25,385},{95,315},{60, 350}},
	{5,{25,285},{95,215},{60, 250}}
};
...
int IsFramePlant(float&, float&, const std::vector<FS>&);
